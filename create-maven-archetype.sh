...
sed -i.bk -e "s|spring-fu-jafu-blank|projectName|g" pom.xml
sed -i.bk -e "s|github\.com/making/projectName|github.com/making/spring-fu-jafu-blank|g" pom.xml
...
sed -i.bk -e "s|projectName|spring-fu-jafu-blank|g" pom.xml
